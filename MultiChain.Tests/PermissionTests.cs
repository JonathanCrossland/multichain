...
namespace BlockChainAPITester
{
    ...
    public class PermissionTests
    {
        ...
        public void ListPermissions()
        {
            ...
            Task.Run(async () =>
            {
                response = await _Client.Permission.ListPermissionsAsync( "1b1cuAeEyT7w4rr7pkhY8ZCQnJ1dRXNPAfUrft" );
        ...
        public void ListPermissionsArray()
        {
            ...
            Task.Run(async () =>
            {
                response = await _Client.Permission.ListPermissionsAsync(new List<string>() { "1b1cuAeEyT7w4rr7pkhY8ZCQnJ1dRXNPAfUrft" });
            }).GetAwaiter().GetResult();
