...
namespace BlockChainAPITester
{
    ...
    public class ProcessCalls
    {
        ...
        private string _RootAddress = "16QPmcz9AT76qhTuE52xoFER7kqn9UrPGyAogC";
        ...
        public void CreateTransaction()
        {
            ...
            Debug.WriteLine("Issue asset: " + assetName);
            JsonRpcResponse<string> response = null;
            Task.Run(async () =>
            {
                response = await _Client.Asset.IssueAsync(_RootAddress, assetName, 1, 1, 10);
