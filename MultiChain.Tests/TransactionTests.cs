...
namespace BlockChainAPITester
{
    ...
    public class TransactionTests
    {
        ...
        {
            JsonRpcResponse<BlockResponse> blockresponse = _Client.Block.GetBlock(63, true);
        ...
        public void GetRawTransactionAsync()
        {
            ...
            if (blockresponse.Result.Tx.Count < 3) throw new Exception("There is no transaction to test");
