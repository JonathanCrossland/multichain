...
namespace MultiChainTests
{
    ...
    public class UtilityTests
    {
        ...
        //[TestMethod]
        //public void Help_getrawmempool()
        //{
        //    JsonRpcResponse<string> response = null;
        //    Task.Run(async () =>
        //    {
        //        response = await _Client.Utility.HelpAsync("getrawmempool");
        //    }).GetAwaiter().GetResult();

        //    ResponseLogger<string>.Log(response);
        //}
        //[TestMethod]
        //public void GetPeerInfoAsync()
        //{
        //    JsonRpcResponse<List<PeerResponse>> response = null;
        //    Task.Run(async () =>
        //    {
        //        response = await _Client.Peer.GetPeerInfoAsync();
        //    }).GetAwaiter().GetResult();

        //    ResponseLogger<List<PeerResponse>>.Log(response);
        //}
        //[TestMethod]
        ...
        //    Task.Run(async () =>
        //    {
        //        response = await _Client.Utility.SetGenerateAsync(true);
        //    }).GetAwaiter().GetResult();
        ...
        //    Task.Run(async () =>
        //    {
        //        response = await _Client.Utility.SetGenerateAsync(false);
        //    }).GetAwaiter().GetResult();
        ...
        //[TestMethod]
        //public void GetGenerateAsync()
        //{
        //    JsonRpcResponse<bool> response = null;
        //    Task.Run(async () =>
        //    {
        //        response = await _Client.Utility.GetGenerateAsync();
        //    }).GetAwaiter().GetResult();
        ...
        //[TestMethod]
        //public void GetHashesPerSecAsync()
        //{
        //    JsonRpcResponse<int> response = null;
        //    Task.Run(async () =>
        //    {
        //        response = await _Client.Utility.GetHashesPerSecAsync();
        //    }).GetAwaiter().GetResult();
        ...
        //[TestMethod]
        //public void GetNetworkHashPsAsync()
        //{
        //    JsonRpcResponse<long> response = null;
        //    Task.Run(async () =>
        //    {
        //        response = await _Client.Utility.GetNetworkHashPsAsync();
        //    }).GetAwaiter().GetResult();

        //    ResponseLogger<long>.Log(response);
        //}
    }
}
